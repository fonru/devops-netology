...
В рамках этой задачи бакет зарегистрировал бакет в яндекс cloud и подключил его в terraform \
...
Terraform will perform the following actions:
  ...
  # yandex_compute_instance.instance_1[0] will be created
  ...
  # yandex_compute_instance.instance_1[1] will be created
  + resource "yandex_compute_instance" "instance_1" {
      + created_at                = (known after apply)
      + folder_id                 = (known after apply)
      + fqdn                      = (known after apply)
  ...
  # yandex_compute_instance.instance_2["1"] will be created
  ...
  # yandex_compute_instance.instance_2["2"] will be created
  + resource "yandex_compute_instance" "instance_2" {
      + created_at                = (known after apply)
      + folder_id                 = (known after apply)
      + fqdn                      = (known after apply)
